    ...
    */
    ((AutoCAD => {
        ...
        */
        ...
        const PromptStatus = AutoCAD.PromptStatus;
        ;
        ...
        */
        ...
        const ResultValueType = AutoCAD.ResultValueType;
        ;
        ...
        */
        ...
        const DragStatus = AutoCAD.DragStatus;
        ;
        ...
        */
        ...
        const DragCursor = AutoCAD.DragCursor;
        ;
        ...
        */
        ...
        const CursorType = AutoCAD.CursorType;
        ;
        ...
        */
        ...
        const UserInputControls = AutoCAD.UserInputControls;
        ;
        ...
        */
        ...
        const TaskDialogResult = AutoCAD.TaskDialogResult;
        ...
        */
        ...
        const TaskDialogButton = AutoCAD.TaskDialogButton;
        ...
        */
        ...
        const CommandFlag = AutoCAD.CommandFlag;
        ;
        ...
        *
        */
        AutoCAD.extend = (subClass, baseClass) => {
        ...
        */
        ...
        const Enum_Projection = AutoCAD.Enum_Projection;
        ;
        ...
        */
        ...
        const ErrorStatus = AutoCAD.ErrorStatus;
        ;
    ...
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
        ...
        */
        const TransientManager = ((() => {
            class TransientManager {
                ...
                *
                */
                transientManager_event(eventArgs) {
                    if (!eventArgs) {
                        return;
                    }
                ...
                *
                */
                addTransient(transient, xmlData) {
                    if (!this.IsRegisteredForEvents) {
                        const obj = this;
                        AutoCAD.TransientManagerInterop.addHandler_mouseChanged(eventArgs => {
                ...
                *
                */
                updateTransient(transientId, xmlData) {
                ...
                *
                */
                showTransients(transientIds, bShow) {
                ...
                *
                */
                generateImage(imgtype, imgId, imgPostedBy, imgMessage) {
                    const jsonStr = exec(JSON.stringify({ functionName: 'Ac_Transientmanager_generateimage', invokeAsCommand: false, functionParams: { type: imgtype, id: imgId, postedby: imgPostedBy, message: imgMessage } }));
                    return jsonStr;
                }
                ...
                */
                getIndex(id) {
                    for (let i = 0, len = this.transients.length; i < len; i++) {
                ...
                *
                */
                setEventHandlingBehavior(id, eventname, bFilter) {
        ...
        const Transient = ((() => {
            class Transient {
                ...
                */
                ...
                setEventHandlingBehavior(eventname, bFilter) {
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        */
        const OSet = ((() => {
            class OSet {
                ...
                getIndex(id) {
                    for (let i = 0, len = this.dbObjects.length; i < len; i++) {
                ...
                */
                add(id) {
                    ...
                    if (typeof id === "string" || typeof id === "number") {
                        ...
                        for (let i = 0, len = id.getCount(); i < len; i++) {
        ...
        */
        const DBEntity = ((() => {
            class DBEntity {
                ...
                */
                getExtents() {
                    const obj = Acad.DBEntityInterop.getExtents(this.entityId);
                    const minPoint = new Acad.Point3d(obj.minPoint3d.x, obj.minPoint3d.y, obj.minPoint3d.z);
                    const maxPoint3d = new Acad.Point3d(obj.maxPoint3d.x, obj.maxPoint3d.y, obj.maxPoint3d.z);
                    const result = new Acad.Bounds3d(minPoint, maxPoint3d);
                    return result;
                }
                ...
                */
                getProperties() {
                    const propArray = Acad.DBEntityInterop.getProperties(this.entityId);
        ...
        */
        ...
        const TaskDialog = AutoCAD.TaskDialog;
        ;
        ...
        */
        ((Application => {
            ...
            */
            ...
            ((activedocument => {
                ...
                let bIsRegisteredForNotification = false;
                ...
                */
                function objectModifiedCallback(eventArgs) {
                    const id = eventArgs.id;
                    const eventname = Acad.Application.activedocument.eventname.modified;
                    const eventobj = dbobjects[id];
                    if (eventobj) {
                ...
                */
                function objectErasedCallback(eventArgs) {
                    const id = eventArgs.id;
                    const eventname = Acad.Application.activedocument.eventname.erased;
                    const eventobj = dbobjects[id];
                    if (eventobj) {
                        eventobj.dispatchEvent(eventname, eventArgs);
                    }
                ...
                */
                function startObserving(oset, eventname, fn) {
                    ...
                    let objId;
                    for (let i = 0, len = oset.getCount(); i < len; i++) {
                        objId = oset.getId(i);
                        let eventobject = dbobjects[objId];
                        if (!eventobject) {
                ...
                */
                function stopObserving(oset, eventname, fn) {
                    ...
                    const ids = [];
                    for (let i = 0; i < osetCount; i++) {
                        const objId = oset.getId(i);
                        const eventobject = dbobjects[objId];
                        if (eventobject) {
        ...
        const Application = AutoCAD.Application;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        */
        const PromptOptions = ((() => {
            class PromptOptions {
                constructor(messageAndKeywords) {
                ...
                */
                setMessageAndKeywords(messageAndKeywords, globalKeywords) {
                    ...
                    if (globalKeywords) {
                        const startKeywords = messageAndKeywords.lastIndexOf("[");
                        const endKeywords = messageAndKeywords.lastIndexOf("]");
                        if (startKeywords >= 0 && endKeywords > startKeywords + 1) {
                            const displayKeywordsText = messageAndKeywords.substr(startKeywords + 1, (endKeywords - startKeywords - 1)).trim();
                        ...
                        const start = messageAndKeywords.lastIndexOf('[');
                        const end = messageAndKeywords.lastIndexOf(']');
        ...
        *
        */
        const PromptEditorOptions = ((_super => {
            __extends(PromptEditorOptions, _super);

            class PromptEditorOptions {
                constructor(messageAndKeywords) {
                ...
                get allowArbitraryInput() {
                    return this._allowArbitraryInput;
                }

                set allowArbitraryInput(x) {
        ...
        *
        */
        const PromptNumericalOptions = ((_super => {
        ...
        *
        */
        const PromptIntegerOptions = ((_super => {
            __extends(PromptIntegerOptions, _super);

            class PromptIntegerOptions {
                constructor(messageAndKeywords, lowerLimit, upperLimit) {
                    _super.call(this, messageAndKeywords);
        ...
        *
        */
        const PromptDoubleOptions = ((_super => {
        ...
        *
        */
        const PromptDistanceOptions = ((_super => {
        ...
        *
        */
        const PromptCornerOptions = ((_super => {
        ...
        *
        */
        const PromptPointOptions = ((_super => {
        ...
        *
        */
        const PromptStringOptions = ((_super => {
        ...
        *
        */
        const PromptAngleOptions = ((_super => {
            __extends(PromptAngleOptions, _super);

            class PromptAngleOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
        ...
        *
        */
        const PromptKeywordOptions = ((_super => {
        ...
        *
        */
        const PromptEntityOptions = ((_super => {
            __extends(PromptEntityOptions, _super);

            class PromptEntityOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                    this._rejectMessage = "";
                ...
                *
                */
                addAllowedClass(newclassName, exactMatch) {
                    ...
                    for (const index in this._allowedClasses) {
                        const obj = this._allowedClasses[index];
                    ...
                    const allowed = { "className": newclassName, "exactMatch": exactMatch };
        ...
        *
        */
        const PromptNestedEntityOptions = ((_super => {
            __extends(PromptNestedEntityOptions, _super);

            class PromptNestedEntityOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                ...
                get nonInteractivePickPoint() {
                    return this._nonInteractivePickPoint;
                }

                set nonInteractivePickPoint(point) {
                    if (point instanceof Acad.Point3d) {
        ...
        *
        */
        const JigPromptOptions = ((_super => {
            __extends(JigPromptOptions, _super);

            class JigPromptOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                ...
                get specialCursorType() {
                    return this._specialCursorType;
                }

                set specialCursorType(x) {
                    const col = Acad.CursorType;
                    let isValid = false;
                    for (const name in col) {
                        if (name == x) {
        ...
        * @throws TypeError
        */
        const JigPromptGeometryOptions = ((_super => {
            __extends(JigPromptGeometryOptions, _super);

            class JigPromptGeometryOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                    this._basePoint = new Acad.Point3d(0, 0, 0);
        ...
        *
        */
        const JigPromptDistanceOptions = ((_super => {
            __extends(JigPromptDistanceOptions, _super);

            class JigPromptDistanceOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                    this._defaultValue = 0.0;
                }
        ...
        * @throws TypeError
        */
        const JigPromptAngleOptions = ((_super => {
            __extends(JigPromptAngleOptions, _super);

            class JigPromptAngleOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                    this._defaultValue = 0.0;
        ...
        * @throws TypeError
        */
        const JigPromptPointOptions = ((_super => {
            __extends(JigPromptPointOptions, _super);

            class JigPromptPointOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
        ...
        * @throws TypeError
        */
        const JigPromptStringOptions = ((_super => {
            __extends(JigPromptStringOptions, _super);

            class JigPromptStringOptions {
                constructor(messageAndKeywords) {
                    _super.call(this, messageAndKeywords);
                    this._defaultValue = "";
                }
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        *
        */
        const PromptIntegerResult = ((_super => {
        ...
        *
        */
        const PromptDoubleResult = ((_super => {
        ...
        *
        */
        const PromptPointResult = ((_super => {
        ...
        *
        */
        const PromptEntityResult = ((_super => {
        ...
        *
        */
        const PromptNestedEntityResult = ((_super => {
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        *
        */
        const PromptSelectionResult = ((_super => {
    ...
    */
    ((AutoCAD => {
        ((SystemVariableCollection => {
            ...
            const eventname = { "SysVarsChanged": "SysVarsChanged" };
            const sysvarToCallback = {};
            ...
            */
            function systemVariableCollectionCallback(changedSysvars) {
                ...
                for (var i = 0; i < callbackArray.length; ++i) {
                    ...
                    const args = callbackToSysvar[callback.acad_sysvar_callback_index];
            ...
            */
            function addEventListener(sysvars, callback) {
                ...
                // Register callback
                const sysvarNames = sysvars.split(",");
                ...
                for (var i = 0; i < sysvarNames.length; ++i) {
                    if (!sysvarToCallback[sysvarNames[i]].includes(callback))
            ...
            */
            function removeEventListener(sysvars, callback) {
                ...
                const sysvarNames = sysvars.split(",");
                const sysvarsToUnregister = [];

                for (const i in sysvarNames) {
                    const sysvarName = sysvarNames[i];
                    if (sysvarToCallback[sysvarName] != undefined) {
                        const index = sysvarToCallback[sysvarName].indexOf(callback);
            ...
            */
            function getSystemVariable(name) {
                ...
                const sysVarInterop = Acad.SysVarCollectionInterop.getSysVar(name);

                const sysVar = new AutoCAD.SystemVariable(sysVarInterop.name, sysVarInterop.valueType, sysVarInterop.value, sysVarInterop.isActive, sysVarInterop.minimum, sysVarInterop.maximum);
        ...
        const SystemVariableCollection = AutoCAD.SystemVariableCollection;
        ...
        */
        const SystemVariable = ((() => {
            class SystemVariable {
                constructor(sName, type, sValue, active, min, max) {
                    this.eventObject = new Acad.EventObject();
                ...
                get isActive() {
                    const jsonObj = Acad.SysVarCollectionInterop.getSysVar(this._name);
                ...
                set value(valToSet) {
                    ...
                    const typedValueInterop = {
                        value: strVal,
                        type: this._valueType
                    };

                    const ret = Acad.SysVarCollectionInterop.setSysVarValue(this._name, typedValueInterop);
                }

                checkIfValidValue(val) {
                    switch (this._valueType) {
                        case Acad.ResultValueType.RTSHORT:
                        case Acad.ResultValueType.RTLONG:
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        */
        ((DataItemCollectionManager => {
            DataItemCollectionManager.dataItemCollectionSet = new Array();
            let handlerAdded = handlerAdded || false;
            const eventName = {
            ...
            */
            function getKnownCollection(colName) {
                ...
                const promise = new Autodesk.JavaScript.Promise();
                ...
                if (DataItemCollectionManager.dataItemCollectionSet[colName] == undefined) {
                    ...
                    AutoCAD.DataItemCollectionManagerInterop.getKnownCollection(colName).then(retvalue => {
                        const obj = retvalue;
                        ...
                        if (obj) {
                            const thisColl = DataItemCollectionManager.dataItemCollectionSet[obj.collectionName];
                            for (let index = 0; index < obj.dataItems.length; ++index) {
                                thisColl.dataItems.push(new AutoCAD.DataItem(obj.dataItems[index].id, obj.dataItems[index].name));
                            }
                            promise.success(thisColl);
                        }
                    }, (retCode, retErrorString) => {
            ...
            */
            function reset_event(args) {
                ...
                const eventname = eventName["reset"];
                const collection = DataItemCollectionManager.dataItemCollectionSet[obj.collectionName];
                if (!collection) {
                    return;
                }
                ...
                const dataitems = obj.dataItems;
                const newItemsCount = dataitems.length;
            ...
            */
            function collectionchanged_event(args) {
                ...
                // Add newItems to the dataItems array.
                const newitems = obj.newItems;
                const newItemsCount = newitems.length;
                const startIndex = collection.dataItems.length;
            ...
            */
            function itemschanged_event(args) {
                ...
                const dataItems = collection.dataItems;
                const eventname = eventName["itemsChanged"];

                // Update changed items in the dataItems array.
                const changeditems = obj.changedItems;
                const changedItemsCount = changeditems.length;
                for (let i = 0; i < changedItemsCount; i++) {
                    const dataItemsCount = dataItems.length;
                    for (let j = 0; j < dataItemsCount; j++) {
        ...
        const DataItemCollectionManager = AutoCAD.DataItemCollectionManager;
        ;
        ...
        */
        const DataItem = ((() => {
            class DataItem {
                ...
                */
                getProperties() {
                    const response = AutoCAD.DataItemInterop.getProperties(this.id);
                    ...
                    const properties = {};
                    for (let i = 0; i < obj.propertyPairs.length; i++) {
    ...
    ((AutoCAD => {
        ((Editor => {
            ...
            */
            function cancelCommand() {
                const retCode = AutoCAD.EditorInterop.cancelCommand();
            ...
            function executeCommandWorker(commands, onSuccess, onError) {
                ...
                const retCode = AutoCAD.EditorInterop.executeCommand(commands, onSuccess, onError);
                if (retCode != Acad.ErrorStatus.eJsOk) {
            ...
            */
            function executeCommand() {
                const commands = [];
                for (let _i = 0; _i < (arguments.length - 0); _i++) {
            ...
            */
            ...
            function executeCommandAsync() {
                ...
                const promise = new Autodesk.JavaScript.Promise();
                callbackCounter++;
                const onSuccessName = `ac_eca_onSuccess${callbackCounter.toString()}`;
                const onErrorName = `ac_eca_onError${callbackCounter.toString()}`;
            ...
            */
            function addCommand(groupName, globalName, localName, flags, jsFunc) {
                ...
                const retCode = AutoCAD.EditorInterop.addCommand(groupName, globalName, localName, flags);
                console.log(retCode);
                if (retCode != Acad.ErrorStatus.eJsOk) {
        ...
        */
        function promptExecAsync(param) {
            const promptResult = new Acad.PromptResults(Acad.PromptStatus.OK);
            execAsync(JSON.stringify(param), result => {
        ...
        ((Editor => {
            ((CurrentViewport => {
                ...
                */
                function pointToScreen(inputPoint) {
                    ...
                    const jsonObj = AutoCAD.CurrentViewportInterop.pointToScreen(inputPoint);
                ...
                */
                function pointToWorld(inputPoint) {
                    ...
                    const jsonObj = AutoCAD.CurrentViewportInterop.pointToWorld(inputPoint);
                ...
                */
                function ucsToWorld(inputPoint) {
                    ...
                    const jsonObj = AutoCAD.CurrentViewportInterop.ucsToWorld(inputPoint);
                    return new Acad.Point3d(jsonObj.x, jsonObj.y, jsonObj.z);
                }
                ...
                */
                function worldToUCS(inputPoint) {
                    ...
                    const jsonObj = AutoCAD.CurrentViewportInterop.worldToUCS(inputPoint);
                    return new Acad.Point3d(jsonObj.x, jsonObj.y, jsonObj.z);
                }
                ...
                */
                function getViewport() {
                    const jsonObj = AutoCAD.CurrentViewportInterop.getViewport();
                ...
                */
                function getViewProperties() {
                    const jsonObj = AutoCAD.CurrentViewportInterop.getViewProperties();
                    const position = new Acad.Point3d(jsonObj.position.x, jsonObj.position.y, jsonObj.position.z);
                    const target = new Acad.Point3d(jsonObj.target.x, jsonObj.target.y, jsonObj.target.z);
                    const upVector = new Acad.Vector3d(jsonObj.upVector.x, jsonObj.upVector.y, jsonObj.upVector.z);
                    const fieldWidth = jsonObj.fieldWidth;
                    const fieldHeight = jsonObj.fieldHeight;
                    const projection = jsonObj.projection;
                ...
                Object.defineProperty(CurrentViewport, "position", {
                    get() {
                        const position = AutoCAD.CurrentViewportInterop.get_position();
                ...
                Object.defineProperty(CurrentViewport, "target", {
                    get() {
                        const target = AutoCAD.CurrentViewportInterop.get_target();
                ...
                Object.defineProperty(CurrentViewport, "upVector", {
                    get() {
                        const upVector = AutoCAD.CurrentViewportInterop.get_upVector();
            ...
            const CurrentViewport = Editor.CurrentViewport;
        }))(AutoCAD.Editor || (AutoCAD.Editor = {}));
        var Editor = AutoCAD.Editor;
        ;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
...
((Autodesk => {
    ((JavaScript => {
        ...
        const ErrorStatus = JavaScript.ErrorStatus;
    }))(Autodesk.JavaScript || (Autodesk.JavaScript = {}));
    const JavaScript = Autodesk.JavaScript;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ((ActiveDocumentInterop => {
            ...
            function highlight(objIds) {
                const jsonStr = exec(JSON.stringify({
            ...
            let objectModified_handlers = null;
            ...
            function objectModifiedCallback(args) {
                ...
                const objectModifiedEventArgs = obj.objectModifiedEventArgs;

                for (let i = 0; i < objectModified_handlers.length; ++i)
            ...
            function addHandler_objectModified(userFunction) {
                const separator = (typeof (apiVersion) == 'function' && apiVersion() > 2) ? '.' : '_';
            ...
            let objectErased_handlers = null;
            ...
            function objectErasedCallback(args) {
                ...
                //unpack all event arguments
                const objectErasedEventArgs = obj.objectErasedEventArgs;

                for (let i = 0; i < objectErased_handlers.length; ++i)
        ...
        const ActiveDocumentInterop = AutoCAD.ActiveDocumentInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ((ApplicationInterop => {
            ...
            function showTaskDialog(strWindowTitle, strMainInstruction, strContentText, nCommonButtons) {
                ...
                execAsync(JSON.stringify({
                    ...
                    functionParams: { strWindowTitle, strMainInstruction, strContentText, nCommonButtons }
                }), result => {
                    if (typeof (promise.success) == 'function') {
                        const resObj = JSON.parse(result);
                        if (typeof (apiVersion) == 'function' && apiVersion() > 2) {
            ...
            function showDeleteConfirmationTaskDialog(strTitle, strMessage) {
                ...
                execAsync(JSON.stringify({
                    ...
                    functionParams: { strTitle, strMessage }
                }), result => {
                    if (typeof (promise.success) == 'function') {
                        const resObj = JSON.parse(result);
                        if (typeof (apiVersion) == 'function' && apiVersion() > 2) {
            ...
            function addPalette(paletteName, url) {
                ...
                execAsync(JSON.stringify({
                    ...
                    functionParams: { paletteName, url }
                }), result => {
                    if (typeof (promise.success) == 'function') {
                        const resObj = JSON.parse(result);
                        if (typeof (apiVersion) == 'function' && apiVersion() > 2) {
            ...
            function showTooltip(position, tooltip) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { position, tooltip }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            let applicationReadyEvent_handlers = null;

            //called by native code: fires event to callback supplied by the user
            function applicationReadyEventCallback(args) {
                const obj = JSON.parse(args);

                for (let i = 0; i < applicationReadyEvent_handlers.length; ++i)
        ...
        const ApplicationInterop = AutoCAD.ApplicationInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ///<reference path="CommonTypes.ts"/>
    ((AutoCAD => {
        ((CurrentViewportInterop => {
            function dolly(dollyVector, animate) {
                const jsonStr = exec(JSON.stringify({
                    functionName: 'Ac_CurrentViewportInterop.dolly',
                    functionParams: { dollyVector, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function roll(rollAngle, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { rollAngle, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function orbit(angleX, angleY, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { angleX, angleY, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function zoomExtents(minPoint, maxPoint, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { minPoint, maxPoint, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function zoom(zoomFactor, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { zoomFactor, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function zoomWindow(lowerLeft, upperRight, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { lowerLeft, upperRight, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function setView(position, target, upVector, fieldWidth, fieldHeight, projection, animate) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { position, target, upVector, fieldWidth, fieldHeight, projection, animate }
                }));
                const jsonObj = JSON.parse(jsonStr);
        ...
        const CurrentViewportInterop = AutoCAD.CurrentViewportInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
    ...
    ((AutoCAD => {
        ((DataItemCollectionManagerInterop => {
            ...
            function resetEventCallback(args) {
                ...
                //unpack all event arguments
                const eventArgs = obj.eventArgs;

                for (let i = 0; i < resetEvent_handlers.length; ++i)
            ...
            let collectionChangedEvent_handlers = null;
            ...
            function collectionChangedEventCallback(args) {
                ...
                for (let i = 0; i < collectionChangedEvent_handlers.length; ++i)
            ...
            let itemsChangedEvent_handlers = null;
            ...
            function itemsChangedEventCallback(args) {
                ...
                for (let i = 0; i < itemsChangedEvent_handlers.length; ++i)
        ...
        const DataItemCollectionManagerInterop = AutoCAD.DataItemCollectionManagerInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        const DataItemInterop = AutoCAD.DataItemInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        const DBEntityInterop = AutoCAD.DBEntityInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ((EditorInterop => {
            ...
            function executeCommand(commands, onSuccess, onError) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { commands, onSuccess, onError }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            function addCommand(groupName, globalName, localName, flags) {
                ...
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { groupName, globalName, localName, flags }
                }));
            ...
            let commandEndedEvent_handlers = null;
            ...
            function commandEndedEventCallback(args) {
                ...
                for (let i = 0; i < commandEndedEvent_handlers.length; ++i)
        ...
        const EditorInterop = AutoCAD.EditorInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        const JigInterop = AutoCAD.JigInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
...
((Autodesk => {
    ...
    ((AutoCAD => {
        ...
        const SecureFileInterop = AutoCAD.SecureFileInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ((SysVarCollectionInterop => {
            ...
            function setSysVarValue(varName, sysVarValueInterop) {
                const jsonStr = exec(JSON.stringify({
                    ...
                    functionParams: { varName, sysVarValueInterop }
                }));
                const jsonObj = JSON.parse(jsonStr);
            ...
            let sysVarChanged_handlers = null;
            ...
            function sysVarChangedCallback(args) {
                ...
                //unpack all event arguments
                const sysVarsChanged = obj.sysVarsChanged;

                for (let i = 0; i < sysVarChanged_handlers.length; ++i)
        ...
        const SysVarCollectionInterop = AutoCAD.SysVarCollectionInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
var Autodesk;
((Autodesk => {
    ...
    ((AutoCAD => {
        ((TransientManagerInterop => {
            ...
            function setEventHandlingBehavior(id, eventName, bFilter) {
                ...
                execAsync(JSON.stringify({
                    ...
                    functionParams: { id, eventName, bFilter }
                }), result => {
                    if (typeof (promise.success) == 'function') {
                        const resObj = JSON.parse(result);
                        if (typeof (apiVersion) == 'function' && apiVersion() > 2) {
            ...
            let mouseChanged_handlers = null;
            ...
            function mouseChangedCallback(args) {
                ...
                for (let i = 0; i < mouseChanged_handlers.length; ++i)
        ...
        const TransientManagerInterop = AutoCAD.TransientManagerInterop;
    }))(Autodesk.AutoCAD || (Autodesk.AutoCAD = {}));
    const AutoCAD = Autodesk.AutoCAD;
}))(Autodesk || (Autodesk = {}));
